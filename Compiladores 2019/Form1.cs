...
namespace Compiladores_2019
{
    public partial class Form1 : Form
    {
        ...
        public void Analizar()
        {
            ...
            // recore cada caracter del texto 
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int x = 0; x < dataGridView2.RowCount; x++)
            {
             ...
             if(contador_error_compilar==0)
             {
                 ...
                 using (StreamWriter writer = new StreamWriter("C:\\Users\\RICHDOTCOM\\Downloads\\Proyecto Final DOOES\\Proyecto Final DOOES\\DOOES en C++.txt", false)) 
